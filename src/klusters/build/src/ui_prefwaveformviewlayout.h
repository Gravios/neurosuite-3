...
public:
    ...
    void setupUi(QWidget *PrefWaveformViewLayout)
    {
        if (PrefWaveformViewLayout->objectName().isEmpty())
            PrefWaveformViewLayout->setObjectName("PrefWaveformViewLayout");
        ...
        channelList->setObjectName("channelList");
    ...
    {
        PrefWaveformViewLayout->setWindowTitle(QCoreApplication::translate("PrefWaveformViewLayout", "Waveformview", nullptr));
        groupBox1->setTitle(QCoreApplication::translate("PrefWaveformViewLayout", "Waveform gain", nullptr));
        textLabel4_2->setText(QCoreApplication::translate("PrefWaveformViewLayout", "Default gain", nullptr));
        groupBox2->setTitle(QCoreApplication::translate("PrefWaveformViewLayout", "Channel positions", nullptr));
        saveButton->setText(QCoreApplication::translate("PrefWaveformViewLayout", "Save", nullptr));
        textLabel1->setText(QCoreApplication::translate("PrefWaveformViewLayout", "<p>Use the mouse to move the channel IDs up or down the list to fit the physical layout of the channels. Layouts can be saved or loaded using the buttons at the bottom</p>\n"
"\n"
"<p><b>Note: </b> a document must be opened in order to use this feature.</p>", nullptr));
        loadButton->setText(QCoreApplication::translate("PrefWaveformViewLayout", "Load", nullptr));
    } // retranslateUi
