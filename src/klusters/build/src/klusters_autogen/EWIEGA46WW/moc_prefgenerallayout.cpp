...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_PrefGeneralLayout_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_PrefGeneralLayout_t qt_meta_stringdata_PrefGeneralLayout = {
    {
        QT_MOC_LITERAL(0, 17)   // "PrefGeneralLayout"
    },
    "PrefGeneralLayout"
};
...
Q_CONSTINIT static const uint qt_meta_data_PrefGeneralLayout[] = {
...
Q_CONSTINIT const QMetaObject PrefGeneralLayout::staticMetaObject = { {
    QMetaObject::SuperData::link<QWidget::staticMetaObject>(),
    qt_meta_stringdata_PrefGeneralLayout.offsetsAndSizes,
    qt_meta_data_PrefGeneralLayout,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_PrefGeneralLayout_t,
        // Q_OBJECT / Q_GADGET
        QtPrivate::TypeAndForceComplete<PrefGeneralLayout, std::true_type>
    >,
    nullptr
} };
