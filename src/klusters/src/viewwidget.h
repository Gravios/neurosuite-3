...
public:
  ...
  * to the part of the drawing which will actually be drawn onto the widget).
  */
    explicit ViewWidget(KlustersDoc& doc, KlustersView& view, const QColor &backgroundColor, QStatusBar* statusBar, QWidget* parent=nullptr, const char* name=nullptr,
