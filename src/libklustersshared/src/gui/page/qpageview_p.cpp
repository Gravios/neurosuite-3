...
{
  connect(model, &QAbstractItemModel::layoutChanged, this, &QPageTreeView::updateWidth);
  ...
  : QAbstractItemView( parent )
{
  ...
  connect(mTabWidget, &QTabWidget::currentChanged, this, &QPageTabbedView::currentPageChanged);
...
void QPageTabbedView::setModel( QAbstractItemModel *model )
{
  ...
  connect(model, &QAbstractItemModel::layoutChanged, this, &QPageTabbedView::layoutChanged);
