...
class KLUSTERSSHARED_EXPORT QPageDialog : public QExtendDialog
{
  ...
  public:
     ...
     */
    explicit QPageDialog( QWidget *parent = nullptr, Qt::WindowFlags flags = Qt::WindowFlags() );
  ...
  protected:
     ...
     */
    QPageDialog(QPageWidget *widget, QWidget *parent, Qt::WindowFlags flags = Qt::WindowFlags());
    QPageDialog(QPageDialogPrivate &dd, QPageWidget *widget, QWidget *parent, Qt::WindowFlags flags = Qt::WindowFlags());
