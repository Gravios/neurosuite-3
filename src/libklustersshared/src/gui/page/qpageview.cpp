...
void QPageViewPrivate::_k_rebuildGui()
{
  ...
  if ( view && view->selectionModel() ) {
        QObject::disconnect(view->selectionModel(), &QItemSelectionModel::selectionChanged,
                q, nullptr);
  ...
  if ( view->selectionModel() ) {
    QObject::connect(view->selectionModel(), &QItemSelectionModel::selectionChanged,
        q, [q](const QItemSelection &sel, const QItemSelection &desel){ q->d_func()->_k_pageSelected(sel, desel); });
