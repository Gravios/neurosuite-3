...
| Workflow | Use when |
|---|---|
| [First-time spike sort](first-time-sort.md) | New recording: acquire → preprocess → KlustaKwik → curate |
...
| [Empirical priors](empirical-priors.md) | Train per-probe KlustaKwik defaults from accumulated curation logs |
